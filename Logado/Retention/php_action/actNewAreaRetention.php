...
if (!isset($_SESSION['logado']) || !isset($_SESSION['acesso']['retencao']) || !$_SESSION['acesso']['retencao']['incluir'] || !isset($_POST['btnNewArea'])) {
  header('Location: ../../../index');
} else {
  $area = clear(trim($_POST['descArea']));
  $sqlArea = "INSERT INTO areaRetencao (descArea) VALUES ('{$area}')";
  ...
  mysqli_close($connect);
  header("Location: ../newAreaRetention");
}

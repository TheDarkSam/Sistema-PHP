        ...
        <div class="col-lg-12">
          ...
          <div class="card mb-4">
            ...
            <div class="card-header">
              <i class="fas fa-calendar-day mr-1"></i>Nova categoria
            </div>
            <!-- ./ card-header -->
            <!-- card-body -->
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-10 offset-lg-1">
                  ...
                  ?>
                    <!-- form -->
                    <form action="php_action/actNewCategoriaRetention" method="POST">
                      <div class="form-row">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-12">
                          ...
                          <input type="text" class="form-control" id="categoria" name="categoria" required maxlength="40">
                        </div>
                      </div>
                      ...
                      * Campos obrigatórios
                      ...
                      <div class="text-center">
                        <button type="submit" class="btn btn-primary" id="btnNewCategoria" name="btnNewCategoria">Cadastrar Categoria</button>
                      </div>
                    </form>
                    <!-- /. form -->
                  <?php

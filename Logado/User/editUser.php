...
$estados = array("PI" => "Piaui", "MA" => "Maranhoa");
...
// Verificação
if (!isset($_SESSION['logado']) || !isset($_SESSION['acesso']['usuario']) || !$_SESSION['acesso']['usuario']['incluir'] || !$existe) :
        ...
        <div class="col-lg-12">
          ...
          <div class="card mb-4">
            ...
            <div class="card-header">
              <i class="fas fa-users mr-1"></i>Editar usuário
            </div>
            <!-- ./ card-header -->
            <!-- card-body -->
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-10 offset-lg-1">
                  <!-- form -->
                  <form role="form" action="php_action/actEditUser" method="POST" id="formCadastro">
                    <div class="form-row">
